...
#define N 15 //number of bodies, now Sun, Earth, Moon, Jupiter.

double dt=5000, t=0, p[N][3], v[N][3];
...
main()
{
	...
	fpos=fopen("poss.dat","w+");
	fvel=fopen("vels.dat","w+");
	for (t=0;t<31650000*12;t+=dt)
	{
		fprintf(fpos,"%lf ",t);
		fprintf(fvel,"%lf ",t);
